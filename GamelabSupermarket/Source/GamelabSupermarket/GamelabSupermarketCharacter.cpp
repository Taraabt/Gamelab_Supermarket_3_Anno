...
#include "GamelabSupermarketCharacter.h"
...
#include "GamelabSupermarket.h"

AGamelabSupermarketCharacter::AGamelabSupermarketCharacter()
{
...
void AGamelabSupermarketCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	{
		UE_LOG(LogGamelabSupermarket, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void AGamelabSupermarketCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
